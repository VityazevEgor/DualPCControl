            ...
            try
            {
                ...
                using (TaskService ts = new TaskService())
                {
                    if (runOnStartUp)
                    {
                        ...
                        ts.RootFolder.RegisterTaskDefinition("DPC Client", td);
                    }
                    else
                    {
                        if (ts.RootFolder.AllTasks.FirstOrDefault(t => t.Name == "DPC Client") is not null)
                        {
                            ts.RootFolder.DeleteTask("DPC Client");
                        }
                    }
                }
            }
